...
import com.project.user.grpc.DeleteMediaResource;
import com.project.user.grpc.DeleteMediaResponse;
import com.project.user.grpc.MediaManageGrpc;
...
public class MediaGrpcClient implements MediaClient {
    ...
    public ResponseEntity<MediaUploadResponse> saveMediaList(MediaUploadResource resource) {
        try {
            com.project.user.grpc.MediaUploadResponse grpcResponse = grpcClient.uploadMedia(
                com.project.user.grpc.MediaUploadResource.newBuilder()
