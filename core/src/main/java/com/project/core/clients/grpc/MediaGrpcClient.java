...
import com.project.core.grpc.DeleteMediaResource;
import com.project.core.grpc.DeleteMediaResponse;
import com.project.core.grpc.MediaManageGrpc;
...
public class MediaGrpcClient implements MediaClient {
    ...
    public ResponseEntity<MediaUploadResponse> saveMediaList(MediaUploadResource resource) {
        try {
            com.project.core.grpc.MediaUploadResponse grpcResponse = grpcClient.uploadMedia(
                com.project.core.grpc.MediaUploadResource.newBuilder()
