        ...
        <div class="whatsapp-container">
            <div class="card">
                ...
                <form id="kc-register-form" action="${url.registrationAction}" method="post">
                    <div id="step1">
                        <img id="profileImage" src="${url.resourcesPath}/img/user.svg" class="profile-image" alt="Profile Image" />
                        <input type="file" id="imageUpload" accept="image/*" autocomplete="off" hidden>
                        <input type="text" id="imageUrl" name="imageUrl" autocomplete="off" hidden>
                ...
                <div class="links">
                    <a href="${url.loginUrl}" id="back-to-login">Already have an account? Log in</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    const mediaServiceBaseUrl = "${properties.mediaServiceBaseUrl!'http://localhost:8092'}";
    const signupUrl = "${url.registrationAction}";
